...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " altercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  altercoin-tx [options] <hex-tx> [commands]  Update hex-encoded altercoin transaction\n" +
            "or:     altercoin-tx [options] -create [commands]   Create hex-encoded altercoin transaction\n" +
            "\n";
