# Support for Output Descriptors in Altercoin Core

Since Altercoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `alter1...` for mainnet or `talter1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Altercoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Altercoin Core wallets, a convenience function `combo` is
