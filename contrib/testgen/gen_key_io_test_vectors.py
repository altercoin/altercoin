...
bech32_templates = [
  ...
  ('alter',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('alter',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('alter',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('talter',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('talter',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('talter',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('ralter',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('ralter',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('ralter', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('talter',  17, 32, False, False, False),
  ('ralter',  3,  1, False, False, False),
  ('alter',   15, 41, False, False, False),
  ('talter',  0, 16, False, False, False),
  ('ralter',  0, 32, True,  False, False),
  ('alter',   0, 16, True,  False, False),
  ('talter',  0, 32, False, True,  False),
  ('ralter',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['alter', 'talter', 'ralter']:
