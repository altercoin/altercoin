...
"""Verify that starting altercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start altercoin with -h for help text")
        ...
        self.log.info("Start altercoin with -version for version information")
        ...
        self.log.info("Start altercoind with -fakearg to make sure it does not start")
